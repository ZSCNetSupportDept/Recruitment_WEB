...
class Student {
	...
	const REGEX_CLASS = '/^(应用化学|食品质量与安全|环境工程|生物制药|材料科学与工程|通信工程|通信工程（2\+2）|电子科学与技术|电子科学与技术（2\+2）|光电信息科学与工程|电子信息工程|工商管理|物流管理|财务管理|人力资源管理|机械设计制造及其自动化|自动化|自动化（2\+2）|电气工程及其自动化|计算机科学与技术（2\+2）|电子商务|金融学|国际经济与贸易|会展经济与管理|法学|旅游管理|新闻学|行政管理|翻译|英语|商务英语|日语|工业设计|动画|设计学类|计算机类)?$/';
